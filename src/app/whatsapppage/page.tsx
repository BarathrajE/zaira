  ...
  return (
    <div className="relative  bg-transparent">
      ...
      <div className="fixed sm:bottom-6 bottom-15 right-6 z-50">
        ...
        >
          <svg
            className="md:w-8 w-5 h-5 md:h-8"
            fill="currentColor"
            viewBox="0 0 24 24"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
            ...
            <div className="bg-green-500 p-6 text-white text-center">
              ...
              <h3 className="text-xl font-bold">Open WhatsApp?</h3>
            </div>

            {/* Modal Content */}
            <div className="p-6">
              <p className="text-gray-600 text-center mb-6">
                You will be redirected to WhatsApp to start a conversation with us. 
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={handleAllow}
                  className="flex-1 px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors duration-200 font-medium shadow-lg"
                >
                  Open WhatsApp
                </button>
              </div>
